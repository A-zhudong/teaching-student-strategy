...
def train_ensemble(
    ...
    for j in range(ensemble_folds):
        ...
        #print the number of parameters of every part
...
def results_multitask(  # noqa: C901
    ...
    for j in range(ensemble_folds):
        ...
        if ensemble_folds == 1:
            ...
            resume = f"models/{model_name}/best-r{run_id}.pth.tar"
        ...
        y_test, output, _, *ids = model.predict(generator=test_generator)
