...
from crabnet.kingcrab_tranEncoder import CrabNet
...
def get_model(data_dir, mat_prop, classification=False, batch_size=None,
              ...
              pretrained=False, finetune=False, embedding_path = None, transformer_model=True):
...
def load_model(data_dir, mat_prop, classification, file_name, verbose=True, model_name=None,\
                save_model_path=None, pretrained=False, embedding_path=None):
    # Load up a saved network.
    model = Model(CrabNet(compute_device=compute_device, pretrained=pretrained).to(compute_device),\
                  model_name=model_name, verbose=verbose, save_path=save_model_path,\
                  transformer_model=True, embedding_path=embedding_path)
    model.load_network()
...
def save_results(data_dir, mat_prop, classification, file_name, verbose=True,\
                 model_name=None, save_model_path=None, pretrained=False, embedding_path=None):
...
if __name__ == '__main__':
    ...
    # mat_prop = 'mp_e_form'
    mat_prop = 'jarvis_bandgap'
    # save_model_name = 'mp_gappbe_pretrain_finetune_embloss'
    # save_model_path = 'models/mp_bandgap_models/pretrained_models/'
    save_model_name = 'jarvis_bandgap_pretrain_transformer_en_de_Linear_clstoken_adjust_layerNorm_lowerLr_finetune'
    save_model_path = '/home/zd/zd/teaching_net/CrabNet/models/jarvis_bandgap_models/pretrained_transformer'
    # the path of the pretrained model to be used
    # Transfer = None
    Transfer = '/home/zd/zd/teaching_net/CrabNet/models/jarvis_bandgap_models/pretrained_transformer/jarvis_bandgap_pretrain_transformer_en_de_Linear_clstoken_adjust_layerNorm.pth' 
    embedding_loss = False  # whether to using the embedding to calculate the loss
    embedding_path = '/home/zd/zd/teaching_net/data/jarvis/jarvis_bandgap/jarvis_eval_formula_nodesEmbedding.pkl'
    pretrain = False  # whether use the pretrained mode of the crab model structure
